  ...
  define('models/DiscreteFourierSeries',['backbone', 'models/Point2d', 'models/PointSet', 'signal'], function(Backbone, Point2d, PointSet, signal) {
    ...
    return DiscreteFourierSeries = (function(_super) {
      ...
      DiscreteFourierSeries.prototype.recalculatePoints = function() {
        var dftCoefs, emuPointSet, newEmuYValues, newXValues, newYValues;
        ...
        return (this.get("points")).reset(_.map(_.zip(newXValues, newYValues), function(point) {
          var x, y;
          x = point[0], y = point[1];
          return new Point2d({
            x: x,
...
(function() {
  ...
  require(['models/SquareWave', 'models/PlotPointSet', 'views/PlotView', 'models/DiscreteFourierSeries', 'views/FourierSeriesWaveEditorView'], function(SquareWave, PlotPointSet, PlotView, DiscreteFourierSeries, FourierSeriesWaveEditorView) {
    var $editorForm, numCycles, plot, plotView, recreatedSquareWave, recreatedSquareWaveEditorView, squareWave, x;
    ...
    squareWave = new SquareWave({
      ...
      xValues: (function() {
        ...
        _results = [];
        for (x = _i = 0, _ref = plot.width; 0 <= _ref ? _i <= _ref : _i >= _ref; x = 0 <= _ref ? ++_i : --_i) {
          _results.push(x);
        }
        return _results;
      })()
